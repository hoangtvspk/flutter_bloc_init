...
build-web-dev:
	make build-web ENVIRONMENT=dev

build-web-staging:
	make build-web ENVIRONMENT=staging

build-web-prod:
	make build-web ENVIRONMENT=prod
...
run-web-staging:
	make run-web ENVIRONMENT=staging

run-web-prod:
	make run-web ENVIRONMENT=prod
